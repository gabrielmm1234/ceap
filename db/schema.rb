...
ActiveRecord::Schema.define(version: 20180617212819) do
  ...
  create_table "deputy_relatives", force: :cascade do |t|
  ...
  create_table "relative_partnerships", force: :cascade do |t|
